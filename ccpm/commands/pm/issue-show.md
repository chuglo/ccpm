...
- Look for local task file: first check `${CCPM_EPICS_DIR}/*/$ARGUMENTS.md` (new naming)
...
```
📁 Local Files:
   Task file: ${CCPM_EPICS_DIR}/{epic_name}/{task_file}
   Updates: ${CCPM_EPICS_DIR}/{epic_name}/updates/$ARGUMENTS/
