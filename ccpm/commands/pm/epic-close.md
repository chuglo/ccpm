...
Check all task files in `${CCPM_EPICS_DIR}/$ARGUMENTS/`:
...
If yes:
- Move epic directory to `${CCPM_EPICS_DIR}/.archived/{epic_name}/`
...
{If archived}: Archived to ${CCPM_EPICS_DIR}/.archived/
