...
Create `${CCPM_DIR}/testing-config.md` with discovered information:
...
## Execution Rules
1. Always use the test-runner agent from `${CCPM_AGENTS_DIR}/test-runner.md`
...
- Store in `${CCPM_DIR}/testing-config.md`
